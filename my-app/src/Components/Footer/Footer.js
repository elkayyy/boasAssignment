...
import masterCard from '../../Assets/PaymentPhotos/mastercard.png'
import klarna from '../../Assets/PaymentPhotos/klarna.png'
import visa from '../../Assets/PaymentPhotos/visa.png'
import shopPay from '../../Assets/PaymentPhotos/shoppay.avif'
import gpay from '../../Assets/PaymentPhotos/gpay.png'
import amx from '../../Assets/PaymentPhotos/amx.png'
import netzero from '../../Assets/PaymentPhotos/netzero.png'
import profits from '../../Assets/PaymentPhotos/profits.webp'
        ...
        <div className='footerMain'>
            <div className='footerUpper'>
                ...
                <div className='footerUpperLeft'>
                    <img src={logoBoas} alt='' className='footerLogo'></img>
                    <span>You've made it to the end!</span>
                    <span>Thanks for taking the time. If you're here because you're lost, feel free to contact us and we'll get you back on track.</span>
                    <span style={{fontSize:'1.5rem'}}>Follow Us On:</span>
                    <div className='media'>
                ...
                <div className='footerUpperRight'>
                    <span style={{fontSize:'1.5rem'}}>Brands and Press</span>
                    <span>Sell on BOAS</span>
                    <span>All Brands</span>
                    <span>Press</span>
                    <span>Affiliate Program</span>
                    <span style={{fontSize:'1.5rem'}}>NEW TO BOAS?</span>
                    <span>Subscribe to our newsletter to get updates on new offers.</span>
                    <div className='footerUpperRightInputBtn'>
            ...
            <div className='footerDown'>
                <span style={{fontSize:'1.8rem'}}>Supported Payment Methods</span>
                <div className='paymentMethods'>
                <img src={iDeal} alt=''></img>
                <img src={amazon} alt=''></img>
                <img src={payPal} alt=''></img>
                <img src={masterCard} alt=''></img>
                <img src={klarna} alt=''></img>
                <img src={visa} alt=''></img>
                <img src={shopPay} alt=''></img>
                <img src={gpay} alt=''></img>
                <img src={amx} alt=''></img>
                </div>
                <span style={{fontSize:'0.9rem'}}>Privacy Policy  | Terms and Conditions</span>
                <span>Copyright © 2022 BOAS Marketplace</span>
                <div className='footerLogos'>
                <img className='footLogo'src={netzero} alt=''></img>
                <img className='footLogo1'src={profits} alt=''></img>
                </div>
            </div>
