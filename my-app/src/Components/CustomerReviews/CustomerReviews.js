...
const CustomerReviews = () => {
  ...
  const star = <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 64 64"><path fillRule="#ffce31" d="M62 25.2H39.1L32 3l-7.1 22.2H2l18.5 13.7l-7 22.1L32 47.3L50.5 61l-7.1-22.2L62 25.2z"/></svg>
  const dot =  <svg xmlns="http://www.w3.org/2000/svg" width="52" height="52" viewBox="0 0 256 256"><path fillRule="currentColor" d="M144 128a16 16 0 1 1-16-16a16 16 0 0 1 16 16Z"/></svg>
  return (
    <div className='customerReviewsMain'>
        <div className='customerReviewsInner'>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="52" height="52" viewBox="0 0 256 256"><path fillRule="currentColor" d="M128 96a32 32 0 1 0 32 32a32 32 0 0 0-32-32Zm0 48a16 16 0 1 1 16-16a16 16 0 0 1-16 16Z"/></svg>
                {dot} {dot} {dot} {dot}</div>
